...
class Contact extends React.Component {
  ...
  componentDidMount() {
    //--Daniel Tompss Portfolio website Google analytics--
  ...
  render() {
    return (
      <div>
        <Helmet>
                <meta charSet="utf-8" />
                <title>Contact | Daniel Tomps</title>
                <link rel="canonical" href="http://motasimfoad.com/contact" />
                <meta name="description" content="Daniel Tomps | Contact - Product Manager | Project Manager | Software Engineer" />
        </Helmet>
